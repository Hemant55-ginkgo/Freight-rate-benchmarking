...
<style>
    ...
    /* Sidebar — all text elements forced to readable white */
    [data-testid="stSidebar"] * { color: #e8e8f0 !important; }

    /* Sidebar — widget labels, captions, help text */
    ...
    [data-testid="stSidebar"] .stCaption { color: #e8e8f0 !important; }

    /* Sidebar caption / small text slightly dimmed but still readable */
    [data-testid="stSidebar"] .stCaption,
    [data-testid="stSidebar"] small { color: #a0a0b0 !important; }

    /* Sidebar divider */
    [data-testid="stSidebar"] hr { border-color: #2a2d3a; }

    /* Sidebar selectbox and input backgrounds */
...
with col5:
    distance_km = bench_row.get("distance_km", CORRIDORS.get(selected_corridor, {}).get("distance_km", 0))
    st.metric(
        label="Rate per km",
        value=f"€{bench_row['rate_per_km']:.2f}/km",
        delta=f"{int(distance_km):,} km corridor",
    )
